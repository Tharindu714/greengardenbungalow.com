...
if (empty($name)) {
    ...
    echo ("Please Enter the Distance");
        ...
        for ($x = 0; $x < $length; $x++) {
            if (isset($_FILES["img" . $x])) {
                ...
                if (in_array($file_ex, $allowed_img_extension)) {
                    ...
                    Database::insUpdelete("INSERT INTO `package_details`(`img_path`,`name`,`distance`,`description`)
      VALUES ('" . $file_name . "','" . $name . "','" . $distance . "','".$description."')");
                } else {
