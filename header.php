<head>
    ...
    <!-- Title -->
    <title>Green Garden Bungalow</title>
                        ...
                        <div class="sequence-caption">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h2>Feel</h2>
                                        <h1 style="font-size: 63px;">The Beauty Of Nature</h1>
                                        <!-- Paragraph -->
                                        <div class="row">
                                        </div>
                                        <!-- Button -->
                    ...
                    <li class="sequence-slide">
                        ...
                        <div class="sequence-caption">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h2>Enjoy yourself under</h2>
                                        <h1 style="font-size: 63px;">Pleasant Weather</h1>
                                        <div class="elements"> </div>
                        ...
                        <div class="sequence-caption">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h2>Chance to do</h2>
                                        <h1 style="font-size: 63px;">More Interesting Activities</h1>
                                        <div class="elements"> </div>
                                    </div>
                                </div>
                            </div>
