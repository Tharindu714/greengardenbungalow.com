                        ...
                        <div class="col-12 border-0 border-end border-1 border-primary">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active text-light" aria-current="page">Tour Packages</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-12 text-center bg-dark">
                            <h2 class=" text-primary title1 fw-bolder mb-1 ">Add Tour Packages</h2>
                        </div>
                        <hr class="border border-1 border-light" />
                        <div class="col-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row">
                                                            <div class="col-12 text-center">
                                                                <label class="form-label fw-bold text-light text-uppercase" style="font-size:20px;">Add Your Tour Packages Here</label>
                                                            </div>
                                                            ...
                                                            <div class="row mt-3">
                                                                ...
                                                                <div class="col-12 col-lg-6 d-grid mb-3">
                                                                    <input type="text" name="charset" id="distance" class="form-control bg-transparent border border-2 border-info text-light fw-bold" placeholder="Distance From the Bungalow">
                                                                </div>

                                                            </div>
                                                            <div class="row mt-3">
                                                            <div class="col-12 col-lg-12 d-grid mb-3">
                                                    ...
                                                    <div class="col-12 text-center">
                                                        <div class="offset-lg-3 col-12 col-lg-7 d-grid mt-3 mb-3">
                                                            <button class="btn btn-outline-primary fw-bold" onclick="addpackage();">ADD & SAVE</button>
                                                        </div>
